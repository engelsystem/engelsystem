...
class ShiftsFilter {
  ...
  public function setEndTime($endTime) {
    global $max_shift_duration_filter;
    if ($max_shift_duration_filter != 0){
      if ($endTime - $this->startTime > $max_shift_duration_filter) {
        $endTime = $this->startTime + $max_shift_duration_filter;
      }
    }
