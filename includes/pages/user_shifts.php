        ...
        '
            SELECT
                ...
                (
                    ...
                    AND (`angel_types`.`restricted`=0 OR `user_angel_type`.`confirm_user_id` IS NOT NULL)
                         ) AS `own`
            FROM `angel_types`
            ...
            'ORDER BY `user_angel_type`.`user_id` IS NOT NUll AND `user_angel_type`.`confirm_user_id` IS NOT NULL DESC, `angel_types`.`name`
        ',
        [
            $user->id,
        ]
