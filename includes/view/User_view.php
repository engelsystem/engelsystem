...
function User_view_myshift(Shift $shift, $user_source, $its_me, $supporter)
{
    ...
    $myshift = [
        ...
        'duration' => CarbonInterval::diff($shift->start, $shift->end)->format(__('duration.format')),
        'hints' => $night_shift,
...
function User_view_worklog(Worklog $worklog, $admin_user_worklog_privilege, $its_me)
{
    ...
    return [
        ...
        'duration' => CarbonInterval::minutes(round($worklog->hours * 60))->cascade()->format(__('duration.format')),
        'hints' => $night_shift,
        'location' => '',
