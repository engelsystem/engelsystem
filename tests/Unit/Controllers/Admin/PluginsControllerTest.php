...
#[CoversMethod(PluginsController::class, '__construct')]
#[CoversMethod(PluginsController::class, 'list')]
#[CoversMethod(PluginsController::class, 'updateState')]
#[CoversMethod(PluginsController::class, 'getAllPlugins')]
#[CoversMethod(PluginsController::class, 'registerPlugin')]
#[CoversMethod(PluginsController::class, 'handleInstall')]
#[CoversMethod(PluginsController::class, 'handleUninstall')]
#[CoversMethod(PluginsController::class, 'handleUpdate')]
#[CoversMethod(PluginsController::class, 'handleEnable')]
#[CoversMethod(PluginsController::class, 'handleDisable')]
