...
class ShiftsControllerTest extends ApiBaseControllerTest
{
    ...
    public function testEntriesByLocation(): void
    {
        ...
        $this->assertCount(4, $shiftAData['angel_types']);
        // Has users
        $entriesA = collect($shiftAData['angel_types'])->sortBy('angeltype.id');
        $entry = $entriesA[0];
        ...
        $this->assertCount(3, $shiftBData['angel_types']);
        // No users
        $entriesB = collect($shiftBData['angel_types'])->sortBy('angeltype.id');
    ...
    public function testEntriesByAngelType(): void
    {
        ...
        $shift = $data['data'][0];
        $this->assertTrue(count($shift['angel_types']) >= 1);
    }
