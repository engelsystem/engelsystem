...
#[CoversMethod(PluginServiceProvider::class, 'register')]
#[CoversMethod(PluginServiceProvider::class, 'boot')]
#[CoversMethod(PluginServiceProvider::class, 'addPlugin')]
#[CoversMethod(PluginServiceProvider::class, 'getNamespace')]
#[CoversMethod(PluginServiceProvider::class, 'registerNamespaces')]
#[CoversMethod(PluginServiceProvider::class, 'registerPluginInstance')]
#[CoversMethod(PluginServiceProvider::class, 'registerPluginProviders')]
#[CoversMethod(PluginServiceProvider::class, 'registerPluginMiddleware')]
#[CoversMethod(PluginServiceProvider::class, 'registerPluginEventHandlers')]
#[CoversMethod(PluginServiceProvider::class, 'registerPluginConfigOptions')]
