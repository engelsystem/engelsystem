...
#[CoversMethod(Carbon::class, 'createFromDatetime')]
#[CoversMethod(Carbon::class, 'formatDuration')]
class CarbonTest extends TestCase
{
    ...
    public static function invalidDates(): Traversable
    {
    ...
    public static function durations(): Traversable
    {
