        ...
        return Shifts.fetcher.start(function() {
          ...
          return Shifts.db.get_rooms(function(rooms) {
            return Shifts.db.get_my_shifts(function(shifts) {
              ...
              Shifts.log(data);
              return Shifts.$shiftplan.html(Shifts.template.shift);
            });
          });
        });
      });
