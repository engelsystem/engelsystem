    ...
    public function metrics(): Response
    {
        ...
        $data = [
            ...
            'licenses'             => [
                ...
                ['labels' => ['type' => 'forklift_unconfirmed'], 'value' => $this->stats->licenses('forklift')],
                ['labels' => ['type' => 'car_unconfirmed'], 'value' => $this->stats->licenses('car')],
                ['labels' => ['type' => '3.5t_unconfirmed'], 'value' => $this->stats->licenses('3.5t')],
                ['labels' => ['type' => '7.5t_unconfirmed'], 'value' => $this->stats->licenses('7.5t')],
                ['labels' => ['type' => '12t_unconfirmed'], 'value' => $this->stats->licenses('12t')],
                ['labels' => ['type' => 'ifsg_light_unconfirmed'], 'value' => $this->stats->licenses('ifsg_light')],
                ['labels' => ['type' => 'ifsg_unconfirmed'], 'value' => $this->stats->licenses('ifsg')],
                // confirmed licenses
                ['labels' => ['type' => 'forklift_confirmed'], 'value' => $this->stats->licenses('forklift', true)],
                ['labels' => ['type' => 'car_confirmed'], 'value' => $this->stats->licenses('car', true)],
                ['labels' => ['type' => '3.5t_confirmed'], 'value' => $this->stats->licenses('3.5t', true)],
                ['labels' => ['type' => '7.5t_confirmed'], 'value' => $this->stats->licenses('7.5t', true)],
                ['labels' => ['type' => '12t_confirmed'], 'value' => $this->stats->licenses('12t', true)],
                ['labels' => ['type' => 'ifsg_light_confirmed'], 'value' => $this->stats->licenses('ifsg_light', true)],
                ['labels' => ['type' => 'ifsg_confirmed'], 'value' => $this->stats->licenses('ifsg', true)],
            ],
            'users_email' => [
                'type' => 'gauge',
