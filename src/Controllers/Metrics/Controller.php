        ...
        foreach ($this->stats->angelTypes() as $angelType) {
            $angelTypes[] = [
                'labels' => [
                    ...
                    'members' => 'unconfirmed',
                ], 'value' => $angelType['restricted'] ? ($angelType['members'] - $angelType['confirmed']) : 0,
            ];
            $angelTypes[] = [
                'labels' => [
                    'name' => $angelType['name'],
                    'restricted' => $angelType['restricted'],
                    'members' => 'confirmed',
                ], 'value' => $angelType['restricted']
                    ? ($angelType['confirmed'] - $angelType['supporters'])
                    : ($angelType['members'] - $angelType['supporters']),
            ];
            $angelTypes[] = [
                'labels' => [
                    'name' => $angelType['name'],
