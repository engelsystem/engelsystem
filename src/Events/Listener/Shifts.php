...
class Shifts
{
    ...
    public function deletingShift(Shift $shift): void
    {
    ...
    public function deletingShiftEntryCreateWorklog(ShiftEntry $entry): void
    {
        $shift = $entry->shift;
    ...
    public function deletingShiftEntrySendEmail(ShiftEntry $entry): void
    {
        $shift = $entry->shift;
